...
Img.player.src = "//Isaac/client/img/isaac.png";
Img.playerShooting = new Image();
Img.playerShooting.src = "//Isaac/client/img/isaacShooting.png";
Img.enemy = new Image();
Img.enemy.src = "//Isaac/client/img/enemy.png";
Img.enemyShooting = new Image();
Img.enemyShooting.src = "//Isaac/client/img/enemyShooting.png";
Img.playerTear = new Image();
Img.playerTear.src = "//Isaac/client/img/playerTear.png";
Img.enemyTear = new Image();
Img.enemyTear.src = "//Isaac/client/img/enemyTear.png";
Img.map = new Image();
Img.map.src = "//Isaac/client/img/bg.png";
Img.soulFullHeart = new Image();
Img.soulFullHeart.src = "//Isaac/client/img/soulFullHeart.png";
Img.soulHalfHeart = new Image();
Img.soulHalfHeart.src = "//Isaac/client/img/soulHalfHeart.png";
Img.redFullHeart = new Image();
Img.redFullHeart.src = "//Isaac/client/img/redFullHeart.png";
Img.redHalfHeart = new Image();
Img.redHalfHeart.src = "//Isaac/client/img/redHalfHeart.png";
